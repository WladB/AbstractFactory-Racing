...
namespace Racing
{
    public class OffRoadPlayerCar : AbstractPlayerCar
    {

        public override void start()
        {
            model = new PictureBox();
            model.Image = ((Image)Properties.Resources.ResourceManager.GetObject("OffRoad1"));
    ...
    public class OffRoadEnemyCar : AbstractEnemyCar
    {
        public override void start()
        {
            model = new PictureBox();
            model.Image = ((Image)Properties.Resources.ResourceManager.GetObject("OffRoad2"));
            model.SizeMode = PictureBoxSizeMode.AutoSize;
            model.Top += 300;
            speed = 10;
        }
    ...
    public class OffRoadRoad : AbstractRoad
    {
        public override void start(Form form)
        {
            GripCoefficient = 0.3f;
        ...
        {
            road1.BackgroundImage = ((Image)Properties.Resources.ResourceManager.GetObject("Off_Road"));
            road2.BackgroundImage = ((Image)Properties.Resources.ResourceManager.GetObject("Off_Road"));
    ...
    public class FactoryOffRoadRacing : AbstractFactory
    {

        public override AbstractPlayerCar CreatePlayerCar()
        {
            return new OffRoadPlayerCar();
        }
        public override AbstractEnemyCar CreateEnemyCar()
        {
            return new OffRoadEnemyCar();
        }
        public override AbstractRoad CreateRoad()
        {
            return new OffRoadRoad();
        }
        
        public override void play()
        {
            Form form1 = new Form();
            form1.Text = "OffRoadRacing Level";
