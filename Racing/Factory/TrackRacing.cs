...
namespace Racing
{
    public class TrackPlayerCar : AbstractPlayerCar
    {

        public override void start()
        {
            model = new PictureBox();
            model.Image = ((Image)Properties.Resources.ResourceManager.GetObject("Track1"));
    ...
    public class TrackEnemyCar : AbstractEnemyCar
    {
        public override void start()
        {
            model = new PictureBox();
            model.Image = ((Image)Properties.Resources.ResourceManager.GetObject("Track2"));
            model.SizeMode = PictureBoxSizeMode.AutoSize;
            model.Top += 300;
            speed = 10;
        }
    ...
    public class TrackRoad : AbstractRoad
    {
        public override void start(Form form)
        {
            GripCoefficient = 0.9f;
        ...
        {
            road1.BackgroundImage = ((Image)Properties.Resources.ResourceManager.GetObject("TrackRoad"));
            road2.BackgroundImage = ((Image)Properties.Resources.ResourceManager.GetObject("TrackRoad"));
    ...
    public class FactoryTrackRacing : AbstractFactory
    {

        public override AbstractPlayerCar CreatePlayerCar()
        {
            return new TrackPlayerCar();
        }
        public override AbstractEnemyCar CreateEnemyCar()
        {
            return new TrackEnemyCar();
        }
